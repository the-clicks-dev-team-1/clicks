  ...
  return (
    <div className="bg-black text-white">
      ...
      <div className="bg-gradient-to-b from-sky-400 to-purple-500 py-20 text-center">
        <h1 className="text-3xl mt-10 md:text-5xl font-bold">Email Marketing Services</h1>
        ...
        <div className="mt-10 max-w-xl mx-auto">
          <h2 className="text-2xl font-semibold mb-4">Get a Free Email Marketing Consultation</h2>
      ...
      <div className="py-20 px-4 md:px-20 lg:px-40">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-2xl md:text-3xl font-semibold mb-6">What is Email Marketing and Why Does It Matter?</h2>
            <p className="text-lg mb-4">
              Email marketing is a powerful tool for businesses to communicate directly with their audience. 
              By sending personalized, targeted messages, you can build relationships, promote your brand, 
              and drive sales.
            </p>
            <p className="text-lg mb-4">
              Unlike social media, where algorithms control visibility, email marketing allows you to reach your audience directly. 
              This makes it one of the most effective channels for driving engagement and conversions.
            </p>
            <p className="text-lg">
              Our email marketing services are designed to help you create compelling email campaigns that resonate with your audience and deliver measurable results.
            </p>
          </div>
      ...
      <div className="py-20 px-4 md:px-20 lg:px-40 bg-neutral-900">
        <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-center">Why Email Marketing Matters?</h2>
        <p className="text-lg text-center mb-10 max-w-3xl mx-auto">
          Email marketing is crucial for businesses looking to maintain direct communication with their audience, 
          nurture leads, and drive repeat business. With the right strategy, email marketing can be one of the most cost-effective ways to grow your business.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <div className="bg-neutral-800 p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-4">Direct Communication</h3>
            <p>
              Email marketing allows you to communicate directly with your audience, ensuring your message is delivered to their inbox.
            </p>
          </div>
          <div className="bg-neutral-800 p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-4">Personalization</h3>
            <p>
              By sending personalized emails, you can create a more meaningful connection with your audience, leading to higher engagement.
            </p>
          </div>
          <div className="bg-neutral-800 p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-4">Cost-Effective</h3>
            <p>
              Email marketing is one of the most cost-effective marketing channels, providing a high return on investment with minimal costs.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-20 px-4 md:px-20 lg:px-40">
        <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-center">Our Email Marketing Services</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <div className="bg-neutral-800 p-6 rounded-lg">
      ...
      <div className="py-20 px-4 md:px-20 lg:px-40 text-center bg-black">
        ...
        <p className="text-lg mb-8 max-w-2xl mx-auto">
          Contact us today to learn more about our email marketing services and how we can help you build strong relationships with your audience.
        </p>
        <Link
          href="/about/contact"
