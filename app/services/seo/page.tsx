  ...
  return (
    <div className="bg-black text-white">
      ...
      <div className="bg-gradient-to-b from-sky-400 to-purple-500 py-20 text-center">
        <h1 className="text-3xl mt-10 md:text-5xl font-bold">Search Engine Optimization (SEO) Services</h1>
        <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
          Increase your online visibility and drive more traffic to your website with our expert SEO services.
        </p>
        <div className="mt-10 max-w-xl mx-auto">
          <h2 className="text-2xl font-semibold mb-4">Get a Free SEO Consultation</h2>
      ...
      <div className="py-20 px-4 md:px-20 lg:px-40">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-2xl md:text-3xl font-semibold mb-6">What is SEO and Why Does It Matter?</h2>
            <p className="text-lg mb-4">
              SEO, or Search Engine Optimization, is the practice of improving your website’s visibility on search engines like Google. 
              When people search for products or services that you offer, you want your website to appear at the top of the results. 
              SEO helps make that happen.
            </p>
            <p className="text-lg mb-4">
              Think of it this way: if your website were a store, SEO would be like setting up a big sign on the main street, so more people 
              notice and visit you. It’s not just about being seen, though. It’s about being seen by the right people – those who are already 
              interested in what you have to offer.
            </p>
            <p className="text-lg">
              Our SEO services focus on optimizing your website in ways that search engines love, ensuring you attract more visitors, 
      ...
      <div className="py-20 px-4 md:px-20 lg:px-40 bg-neutral-900">
        <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-center">Why SEO Matters?</h2>
        <p className="text-lg text-center mb-10 max-w-3xl mx-auto">
          SEO is the backbone of online visibility. By optimizing your website for search engines, you can increase the quality and quantity of traffic to your site, leading to higher engagement and conversions.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <div className="bg-neutral-800 p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-4">Increase Visibility</h3>
            <p>
              With our SEO strategies, your website will rank higher in search engine results, making it easier for potential customers to find you.
            </p>
          </div>
          <div className="bg-neutral-800 p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-4">Drive More Traffic</h3>
            <p>
              Our SEO services focus on driving more organic traffic to your site, increasing your chances of converting visitors into customers.
            </p>
          </div>
          <div className="bg-neutral-800 p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-4">Improve User Experience</h3>
            <p>
              We optimize your site for both search engines and users, ensuring a seamless experience that keeps visitors engaged.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-20 px-4 md:px-20 lg:px-40">
        <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-center">Our SEO Services</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <div className="bg-neutral-800 p-6 rounded-lg">
      ...
      <div className="py-20 px-4 md:px-20 lg:px-40 text-center bg-black">
        ...
        <p className="text-lg mb-8 max-w-2xl mx-auto">
          Contact us today to learn more about our SEO services and how we can help your business grow.
        </p>
        <Link
          href="/about/contact"
