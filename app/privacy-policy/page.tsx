      ...
      <div className="py-20 px-4 md:px-20 lg:px-40 max-w-7xl mx-auto">
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside mt-4 text-neutral-300">
            ...
            <li>Usage Data: Information about how you interact with our website, such as IP addresses, browser types, and pages viewed.</li>
            <li>Cookies and Tracking Technologies: Information collected through cookies and other tracking technologies.</li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside mt-4 text-neutral-300">
            ...
            <li>Analyzing usage of our website to improve our content and user experience.</li>
            <li>Complying with legal obligations and protecting our legal rights.</li>
          </ul>
        </section>

        <section className="mb-10">
          <h2 className="text-3xl font-semibold mb-4">3. Sharing Your Information</h2>
          <p className="text-neutral-300">
            We may share your information with third parties under certain circumstances, including:
          </p>
          <ul className="list-disc list-inside mt-4 text-neutral-300">
            <li>Service Providers: We may share your information with service providers who help us operate our business.</li>
            <li>Legal Requirements: We may disclose your information to comply with legal obligations or in response to lawful requests by public authorities.</li>
            <li>Business Transfers: We may share or transfer your information in connection with a merger, sale, or other business transaction.</li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          <h2 className="text-3xl font-semibold mb-4">5. Security of Your Information</h2>
          <p className="text-neutral-300">
            We take the security of your information seriously and implement reasonable measures to protect it. However, no method of transmission over the Internet or method of electronic storage is completely secure.
          </p>
        </section>
