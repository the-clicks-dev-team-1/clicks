...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "services.ai.hr",
  });

  return {
    title: t("mainSection.title") || "AI for Human Resources",
    description:
      t("mainSection.description") ||
      "Streamline recruitment and employee management with AI-powered HR solutions.\nImprove hiring processes and retain talent with intelligent workforce management tools.",
  };
}

const servicesItems = en.services.ai.hr.items.map((_, index) => ({
  count: `0${index + 1}`,
...
export default AIForHumanResources;
