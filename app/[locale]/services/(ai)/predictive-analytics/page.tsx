...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "services.ai.predictiveAnalytics",
  });

  return {
    title: t("mainSection.title") || "Predictive Analytics",
    description:
      t("mainSection.description") ||
      "Use predictive AI tools to forecast trends, customer behaviour, and operational needs.\nAnticipate future outcomes and make proactive decisions with confidence.",
  };
}

const servicesItems = en.services.ai.predictiveAnalytics.items.map(
  (_, index) => ({
    count: `0${index + 1}`,
      ...
      <div className="container md:px-10 mb-32 pt-32 md:pt-40">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative w-full h-64 md:h-96">
            <Image
              src="/images/ai/predictiveAnalytics.jpg"
