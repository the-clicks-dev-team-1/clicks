...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "services.ai.development",
  });

  return {
    title: t("mainSection.title") || "Custom AI Development",
    description:
      t("mainSection.description") ||
      "Develop AI solutions tailored to your business needs for maximum impact and efficiency.\nCustomize AI to transform your unique processes, ensuring optimal results.",
  };
}

const servicesItems = en.services.ai.development.items.map((_, index) => ({
  count: `0${index + 1}`,
