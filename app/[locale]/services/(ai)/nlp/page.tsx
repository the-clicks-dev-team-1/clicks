...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "services.ai.nlp",
  });

  return {
    title: t("mainSection.title") || "Natural Language Processing (NLP)",
    description:
      t("mainSection.description") ||
      "Leverage NLP for better communication, customer insights, and content analysis.\nTurn unstructured data into actionable insights for better customer experiences.",
  };
}

const servicesItems = en.services.ai.nlp.items.map((_, index) => ({
  count: `0${index + 1}`,
          ...
          <div>
            <div className="mb-10">
              <div className="flex flex-col">
                <h1 className="mb-1 py-2 leading-loose text-3xl md:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-sky-400 to-purple-500">
                  {t("mainSection.title")}
                </h1>
