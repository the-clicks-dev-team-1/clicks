...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "services.blockchain.tokenization",
  });

  return {
    title: t("mainSection.title") || "Tokenization Services",
    description:
      t("mainSection.description") ||
      "Transform real-world assets into digital tokens for increased liquidity and flexibility.\nUnlock new investment opportunities with secure, tokenized assets.",
  };
}

const servicesItems = en.services.blockchain.tokenization.items.map(
  (_, index) => ({
    count: `0${index + 1}`,
      ...
      <div className="container md:px-10 mb-32 pt-32 md:pt-40">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative w-full h-96 md:h-full md:max-h-[800px]">
            <Image
              src="/images/blockchain/tokenization.jpg"
