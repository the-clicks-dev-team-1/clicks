          ...
          <div className="flex flex-col gap-8 mt-10 md:flex-row items-center justify-center">
            <div className="w-full md:w-1/2 flex-1 text-center md:text-left">
              ...
              <div className="w-full md:hidden overflow-hidden flex-1 rounded-2xl">
                <Image
                  src="/images/company/aboutAgency_marketing.png"
                  alt="Marketing Wave"
                  width={600}
                  height={400}
          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="w-full md:w-1/2">
                <Image
                  src="/images/company/aboutAgency_culture1.png"
                  alt="Culture Image 1"
                  width={600}
                  height={400}
                  className="object-cover rounded-2xl w-full"
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 text-[var(--light-blue)] light:text-[var(--gray-70)]">
              ...
              <div className="w-full md:w-1/2 order-1 md:order-2">
                <Image
                  src="/images/company/aboutAgency_culture2.png"
                  alt="Culture Image 2"
                  width={600}
                  height={400}
                  className="object-cover rounded-2xl w-full"
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 text-[var(--light-blue)] light:text-[var(--gray-70)]">
              <div className="w-full md:w-1/2">
                <Image
                  src="/images/company/aboutAgency_culture3.png"
                  alt="Culture Image 3"
                  width={600}
                  height={400}
                  className="object-cover rounded-2xl w-full"
