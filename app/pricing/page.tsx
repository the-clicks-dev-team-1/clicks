...
const plans = [
  ...
  const offers = [
    {
      ...
      description: "Detailed consultation to understand the client's business goals, target audience, and current marketing efforts. Development of a customized digital marketing strategy.",
      button: "Order Now",
    },
    {
      index: 1,
      ...
      style: "rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
      description: "Creation of a modern, responsive website optimized for user experience and conversions.",
      button: "Order Now",
    },
    {
      index: 2,
      ...
      style: "rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
      description: "On-page and off-page SEO to improve search engine rankings and organic traffic.",
      button: "Order Now",
    },
    {
      index: 3,
      ...
      style: "rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
      description: "Management of PPC campaigns to drive targeted traffic and increase conversions.",
      button: "Order Now",
    },
    {
      index: 4,
      ...
      style: "rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
      description: "Social media strategy, content creation, and community management across platforms like Facebook, Instagram, Twitter, LinkedIn, and others.",
      button: "Order Now",
    },
    {
      index: 5,
      ...
      style: "rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
      description: "Creation and distribution of valuable content to attract and engage the target audience.",
      button: "Order Now",
    },
    {
      index: 6,
      ...
      style: "rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
      description: "Design and execution of email marketing campaigns to nurture leads and retain customers.",
      button: "Order Now",
    },
    {
      index: 7,
      ...
      style: "rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
      description: "Analysis and optimization of website and landing pages to improve conversion rates.",
      button: "Order Now",
    },
    {
      index: 8,
      ...
      style: "rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
      description: "Comprehensive analytics and reporting to track the performance of digital marketing efforts.",
      button: "Order Now",
    },
    {
      index: 9,
      ...
      style: "rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
      description: "Implementation of marketing automation tools to streamline and enhance marketing efforts.",
      button: "Order Now",
    },
  ];
  ...
  const Pricing = () => {
    ...
    return (
      <div className="w-full md:items-center md:justify-center bg-black/[0.96] text-white antialiased bg-grid-white/[0.02] relative overflow-hidden pt-24"> {/* Добавил отступ сверху */}
        <Navbar />
        <div className="flex items-center justify-center flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-6 md:w-4/5 2xl:w-3/4 cursor-pointer pb-10 md:pb-20 items-center">
            {plans.map((plan, index) => (
              <div key={plan.name} className="h-full flex flex-col justify-between border rounded-3xl px-6 py-4 md:py-0">
                <div className={plan.style}>
                  ...
                  <div className="text-2xl md:text-3xl pt-4 md:pt-6">{plan.price}</div>
                ...
                <div className="flex flex-col md:flex-row">
                  <WobbleCard containerClassName="bg-gray-900 rounded-3xl w-full max-w-screen-xl relative">
                    <div className="md:w-2/3">
                      <div className={`text-3xl md:text-4xl font-medium ${offer.style}`}>
                        {offer.name}
                      </div>
                      <div className="py-4 md:py-6 text-white">{offer.description}</div>
                      <ul>
                        {offer.features.map((feature) => (
                          <li key={feature} className="text-lg py-2 flex space-x-2 items-center text-white">
                            <PiCheckCircleFill className="text-green-600 mr-2 text-xl" />
                            {feature}
                          </li>
                        ))}
                  ...
                  <div className="md:w-1/3 px-8 animate-shimmer items-center justify-center rounded-3xl border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                    <div className="whitespace-pre-line text-xl pt-4 md:pt-6 text-white">{offer.price}</div>
