        ...
        <WobbleCard containerClassName="bg-gray-900 rounded-t-3xl w-full max-w-screen-xl mx-auto relative">
            ...
            <div className="px-4 py-6 bg-gradient-to-r from-sky-400 to-purple-500 bg-opacity-50 md:flex md:items-center md:justify-between rounded-b-lg absolute bottom-0 left-0 w-full">
                <span className="text-sm text-white dark:text-gray-300 sm:text-center">
                    © 2024 <a href="https://theclicks.ca">The Clicks™</a>. All Rights Reserved.
                </span>
                <div className="flex mt-4 sm:mt-0 sm:justify-center md:justify-end space-x-5 rtl:space-x-reverse">
                    <a href="https://www.facebook.com/theclicks.ca" className="text-white hover:text-gray-900 dark:hover:text-white">
                        <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                            <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd"/>
                        </svg>
                        <span className="sr-only">Facebook page</span>
                    </a>
                    <a href="https://x.com/theclicks_ca" className="text-white hover:text-gray-900 dark:hover:text-white">
                    ...
                    <a href="https://www.instagram.com/theclicks.ca" className="text-white hover:text-gray-900 dark:hover:text-white">
                        <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
