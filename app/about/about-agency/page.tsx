  ...
  return (
    <div className="bg-black text-white">
      ...
      <div className="px-4 py-8">
        ...
        {/* The Clicks Culture div */}
        <div className="bg-black text-white py-20">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl text-center pb-4 bg-clip-text text-transparent bg-gradient-to-b from-sky-400 to bg-purple-500 bg-opacity-50">The Clicks Culture</h2>
            ...
            <div className="flex flex-col md:flex-row items-center mb-12 gap-8">
              ...
              <div className="w-full md:w-1/2 text-left md:text-right p-4 md:p-6">
                <h3 className="text-lg sm:text-xl font-semibold mb-2">About Us</h3>
                <p className="text-white text-sm md:text-m pb-6 text-justify">
                  The Clicks is a dynamic digital marketing agency where creativity and innovation are at the forefront of everything we do. 
                  Our team is driven by passion and energy, constantly pushing the boundaries to deliver outstanding results. 
                  We are perfectionists who value the quality and impact of our work, and we are committed to driving business success and growth for our clients in the digital space.
                </p>
                <p className="text-white text-sm md:text-m pb-6 text-justify">
                  Our approach to governance combines structured liberalism for regulated aspects of our work with a corporate noocracy that prioritizes flexibility and innovation. 
                  At The Clicks, we emphasize common sense and rational decision-making, ensuring that every action is guided by logic and aimed at achieving the best outcomes. 
                  This balance of freedom and structure, coupled with our non-standard horizontal hierarchy, fosters collaboration and minimizes formalities, empowering our team to contribute their best.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="w-full md:w-1/2 text-left md:text-right p-4 md:p-6">
                <h3 className="text-lg sm:text-xl font-semibold mb-2">Work Process</h3>
                <p className="text-white text-sm md:text-m pb-6 text-justify">
                  At The Clicks, we recognize that our people are the core of our success, and their well-being and productivity are our top priorities. 
                  We are committed to creating a work environment that is both comfortable and highly efficient, providing our team with the tools and support they need to excel. 
                  By constantly enhancing our workplace, we ensure that every team member can perform at their best, driving the exceptional results that define our agency.
                </p>
                <p className="text-white text-sm md:text-m pb-6 text-justify">
                  A distinctive feature of our work process is the integration of gamification and automation. 
                  We make daily tasks more engaging and enjoyable by incorporating elements of play, 
                  which fosters a collaborative and motivated atmosphere. At the same time, we utilize advanced automation to streamline repetitive tasks, 
                  allowing our team to focus on high-impact, strategic activities. This blend of fun and efficiency not only boosts productivity but also inspires creativity and innovation, 
                  enabling us to stay ahead in the ever-evolving digital marketing landscape.
                </p>
              </div>
            </div>
          </div>
