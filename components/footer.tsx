    ...
    >
      ...
      <footer className="relative max-w-7xl mx-auto">
        <div className="px-4 md:px-10 py-6 lg:py-16">
          <div className="grid #grid-cols-[4.5fr_5.5fr] lg:grid-cols-[5.5fr_4.5fr] #lg:grid-cols-[1.5fr_4fr_1.5fr_3fr] gap-2 md:gap-6">
            <div className="flex flex-col gap-2 md:gap-6 justify-center sm:flex-row">
              <div className="flex items-center justify-center sm:justify-start sm:flex-col sm:items-start flex-1 lg:flex-initial">
                <Logo />
              ...
              <div className="w-full place-self-start flex-1 lg:flex-initial">
