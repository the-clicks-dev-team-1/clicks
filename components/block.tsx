...
const Block: React.FC = () => {
  return (
    <div className="px-4 md:px-10 mx-auto relative z-10 w-full max-w-7xl pt-10 pb-20 md:pt-20 flex flex-col md:flex-row items-center justify-center">
      <div className="md:w-1/2 px-4 md:px-8">
        ...
        <p className="mt-4 text-lg font-normal text-[var(--gray-blue)] light:text-[var(--gray-70)] max-w-lg text-left">
