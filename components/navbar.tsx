    ...
    <div ref={animationParent} className="relative">
      {d.children ? (
        <>
          <div
            onClick={toggleItem}
            className="flex items-center justify-between px-2 py-3 text-neutral-400 hover:text-white cursor-pointer"
          >
            <span>{d.label}</span>
            <IoIosArrowDown
        ...
        <ActiveLink
          href={d.link ?? "#"}
          className="flex items-center px-2 py-3 text-neutral-400 hover:text-white"
          onClick={d.closeSideMenu}
        >
          <span>{d.label}</span>
        </ActiveLink>
