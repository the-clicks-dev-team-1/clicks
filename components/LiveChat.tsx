...
const LiveChat = () => {
  useEffect(() => {
    ...
    callUsElement.setAttribute(
      "style",
      "width: 320px; height: 489px; position:fixed;font-size:16px;line-height:17px;z-index: 50;right: 15px; bottom: 80px;--call-us-form-width: 300px; --call-us-form-height: 500px"
    );
