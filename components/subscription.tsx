...
const SubscriptionSection = () => {
  return (
    <div className="py-20 bg-[var(--bg900)] light:bg-[var(--light-blue)]">
      <div className="container px-4 md:px-20 lg:px-40 mx-auto text-center max-w-7xl">
        ...
        <NewsletterForm className="bg-neutral-800 light:bg-[var(--gray-0)] light:border light:border-[var(--ocean-blue)]" />
      </div>
    </div>
  );
};
