...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-[var(--bgnew)] shadow-lg border border-[var(--dark-border-t)] *group-hover:border-slate-700* group-hover:border-[var(--dark-border)]* relative z-20",
        className
      )}
    >
